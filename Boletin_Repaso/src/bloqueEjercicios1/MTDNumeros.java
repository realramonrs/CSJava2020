...
public class MTDNumeros {
	 ...
	 */
		...
		/*8. Programar un método que reciba una matriz 2D de tipo int y devuelva el siguiente String:
			...
			public static String getInfoMatriz(int matriz[][]){
				...
				double mediaFila1 = 0,mediaFila2=0,mediaFila3 = 0;
				String info = "";
				...
				mediaFila1 = sumaFila1/matriz[0].length;
				
				//Fila 1
				for(int valor : matriz[1]){
					sumaFila2+=valor;
				}
				mediaFila2= sumaFila2/matriz[1].length;
				
				//Fila 2
				for(int valor : matriz[2]){
					sumaFila3+=valor;
				}
				mediaFila3 = sumaFila3/matriz[2].length;
				
				double mediaMasAlta = Math.max(mediaFila1, Math.max(mediaFila2, mediaFila3));
				
				info+="La media de la fila 1 es " + mediaFila1 + "\n";
				info+="La media de la fila 2 es " + mediaFila2 + "\n";
				info+="La media de la fila 3 es " + mediaFila3 + "\n";
				
				if(mediaMasAlta==mediaFila1){
					info+="La fila con la media más alta es la 1";
				}
				else if(mediaMasAlta == mediaFila2){
					info+="La media más alta es la 2";
				}
				else{
					info+="La media más alta es la 3";
				}
